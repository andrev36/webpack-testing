import {
 counterDecrementAnimation,
 counterIncrementAnimation,
} from 'components/CounterComponent/counterAnimations'
...
import {
 selectElementHeadingAnimation,
 selectElementWrapperAnimation,
} from 'components/SelectComponent/selectElementAnimations'
...
const MainPageHook = () => {
 ...
 const handleGoToSecondSlide = () => {
  ...
  gsap.fromTo(
   ...
   counterIncrementAnimation()[0],
   counterIncrementAnimation()[1],
  )

  gsap.fromTo(
   '.section-counter__container-decrement',
   counterDecrementAnimation()[0],
   counterDecrementAnimation()[1],
  )
  gsap.fromTo(
   '.heading__picked-color',
   selectElementHeadingAnimation()[0],
   selectElementHeadingAnimation()[1],
  )
  gsap.fromTo(
   '.select-wrapper',
   selectElementWrapperAnimation()[0],
   selectElementWrapperAnimation()[1],
  )
 ...
 const handleGoToThirdSlide = () => {
  goToSlide( 3, )
  gsap.fromTo(
   '.container-reward__btn-reward',
   rewardButtonAnimation()[0],
   rewardButtonAnimation()[1],
  )
 }
