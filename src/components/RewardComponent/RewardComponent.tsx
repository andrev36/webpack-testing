...
const RewardComponent = () => {
 ...
 const chosenAnimalFromStorage: string | null = localStorage.getItem(
  'chosenAnimal',
 )
 const chosenColorFromStorage: string | null = localStorage.getItem(
  'chosenColor',
 )
 const chosenAnimalCountFromStorage: string | null = localStorage.getItem(
  'chosenAnimalCount',
 )
  ...
  <React.Fragment>
   <section className='container-reward'>
    <div className='container-reward__container-heading'>
     <h1 className='container-reward__heading'>
    ...
    <div className='container-reward__container-sun-img'>
     <img
      alt='sun'
      className='container-reward__sun-img'
      src={SunIcon}
      width='100px'
     />
    </div>
    ...
    <div
     className='container-reward__info-treasure-opened'
     data-testid='container-reward__info-treasure-opened'
    >
     {chestOpened ? <h1>Click chest</h1> : null}
    </div>
    <div className='container-reward-part'>
     <svg
      className='container-reward-part__svg-wave1'
